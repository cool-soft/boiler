...
class TestSingleTypeTempDeltaCalculatorWithParameters:
    ...
    def answer(self, requirements_df, reaction_df):
        ...
        for requirement, reaction in zip(requirements_df.iterrows(), reaction_df.iterrows()):
            ...
            reaction_forward_temp = reaction_row[column_names.FORWARD_TEMP] - self.min_model_error
            required_forward_temp = requirement_row[column_names.FORWARD_TEMP] * self.requirements_coefficient
    ...
    @pytest.fixture
    def calculator(self):
        return SingleTypeTempDeltaCalculatorWithParameters(self.requirements_coefficient, self.min_model_error)
