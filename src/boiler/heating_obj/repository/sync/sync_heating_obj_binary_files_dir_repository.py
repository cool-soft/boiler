...
from ...io.sync.sync_heating_obj_binary_file_dumper import SyncHeatingObjBinaryFileDumper
from ...io.sync.sync_heating_obj_binary_file_loader import SyncHeatingObjBinaryFileLoader
from ...io.sync.sync_heating_obj_binary_reader import SyncHeatingObjBinaryReader
from ...io.sync.sync_heating_obj_binary_writer import SyncHeatingObjBinaryWriter


class SyncHeatingObjBinaryFilesDirRepository(SyncHeatingObjRepositoryWithoutTransactions):

    def __init__(self,
                 dir_path: Optional[str] = None,
                 filename_ext: Optional[str] = None,
                 reader: Optional[SyncHeatingObjBinaryReader] = None,
                 writer: Optional[SyncHeatingObjBinaryWriter] = None
                 ) -> None:
    ...
    def get_dataset(self,
        ...
        loader = SyncHeatingObjBinaryFileLoader(
            reader=self._reader,
    ...
    def set_dataset(self, dataset_id: str, heating_obj_df: pd.DataFrame) -> None:
        ...
        dumper = SyncHeatingObjBinaryFileDumper(
            writer=self._writer,
            filepath=dataset_path
        )
